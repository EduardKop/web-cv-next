...
return (
    ...
    <div className='contacts-wrap'><span>Contacts</span></div>
        ...
        <a rel="shortcut icon noopener noreferrer"target="_blank" href={'+380665249893'} > 📞 {'tel:+380665249893'}</a>
        </div>
        ...
        <div className='contacts-item'>
        <a rel="shortcut icon noopener noreferrer" target="_blank" href={'mailto:eduard.korytnyk@gmail.com'}> 📭 {'eduard.korytnyk@gmail.com'}</a>
        </div>
    </div>
    </div>
